...
namespace Painting.Util
{
    public class Physomatik
    {
        ...
        public static double[] GetNewPos (double[] v, double[] pos, double step) => new double[2] { pos[0] + GetXPart (v) * step, pos[1] + GetYPart (v) * step };
        ...
        //you should use this part if you forgot your current position/speed
        {
            ...
            for (double i = 0; i < t; i += step)
            {
                ...
                var Fs = i <= t_throw ? new double[3, 2] { { F_G, 270 }, { F_Wurf, angle_Wurf }, { F_L, (v[1] + 180) % 360 } } : new double[2, 2] { { F_G, 270 }, { F_L, (v[1] + 180) % 360 } };
